...
from forms import loginform,RegisterForm,ArticleForm,updatePassword,forgotPassword,resetform,Bloodrequestform
app= Flask(__name__)
...
def Blood_request():
    ...
    if request.method == 'POST':
        ...
        # Close connection
        cur.close()
        flash('I have sent your request to nearby people, we will find your donour soon', 'success')
